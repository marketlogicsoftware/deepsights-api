...
def test_secondary_text_search():
    ...
    """
    results = ds.contentstore.secondary._text_search(
        query=test_query,
        max_results=5,
    )
...
def test_secondary_vector_search():
    ...
    """
    results = ds.contentstore.secondary._vector_search(
        test_embedding,
        max_results=5,
    )
...
def test_secondary_hybrid_search_only_vector():
    ...
    vector_results = ds.contentstore.secondary._vector_search(
        test_embedding,
        max_results=5,
    )
...
def test_secondary_hybrid_search_only_text():
    ...
    text_results = ds.contentstore.secondary._text_search(
        query=test_query,
        max_results=5,
        recency_weight=0.0,
    )
