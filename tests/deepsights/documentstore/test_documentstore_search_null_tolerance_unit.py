"""
Unit tests for null-tolerant parsing of documentstore search responses (no network).
...
from deepsights.documentstore.resources.documents._search import hybrid_search, topic_search
...
@pytest.mark.parametrize(
    ...
    ids=["context-null", "search-results-null", "context-empty", "no-context-key"],
)
...
def test_topic_search_parses_non_empty_payload_and_skips_empty_entries():
    ...
    assert results[0].page_references[0].relevance_class == "HIGH"
