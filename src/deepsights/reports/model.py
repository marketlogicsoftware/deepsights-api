...
class ReportEvidence(DeepSightsIdTitleModel):
    ...
    Attributes:
        ...
        rating (int): The rating of the evidence's relevance on a 1-5 scale with respect to the report's question.
    ...
    rating: int = Field(
        description="The rating of the evidence's relevance on a 1-5 scale with respect to the report's question."
    )
...
class Report(DeepSightsIdModel):
    ...
    language: str = Field(description="The language of the report.")
