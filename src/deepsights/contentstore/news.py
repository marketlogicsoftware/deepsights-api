...
from deepsights.contentstore._model import NewsSearchResult
...
def news_vector_search(
    ...
    return contentstore_vector_search(
        api,
        item_type="NEWS",
        search_result=lambda i: NewsSearchResult(**i),
...
def news_search(
    ...
    """
    Perform a hybrid search for news articles in the content store.
