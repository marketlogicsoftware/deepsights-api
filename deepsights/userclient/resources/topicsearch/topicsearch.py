...
from deepsights.userclient.resources._model import TopicSearchResult


#################################################
class TopicSearchResource(APIResource):
    """
    ...
    def search(self, query: str, extended_search: bool = False) -> List[TopicSearchResult]:
        """
        ...
        response = self.api.post(
            "end-user-gateway-service/topic-searches", body=body
        )
