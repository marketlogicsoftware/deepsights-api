...
class SecondaryResource(APIResource):
    ...
    def vector_search(
        ...
        search_from_timestamp: datetime | None = None,
        search_to_timestamp: datetime | None = None,
        ...
        return contentstore_vector_search(
            self.api,
            item_type="REPORTS",
            search_result=lambda i: SecondarySearchResult(**{"source_name": i["source"]["display_name"], **i}),
